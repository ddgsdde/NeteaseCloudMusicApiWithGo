...
1.  Copy the `netease_cloud_music` folder to the `music_assistant/providers` directory of your Music Assistant installation (or `custom_providers` if supported).
